export const metadata = {
  title: 'ArFS Protocol: Entity Types',
  description: 'The entity types for the ArFS protocol.',
  openGraph: {
    title: 'ArFS Protocol: Entity Types',
  },
}
...
<div className="text-center text-xs">Drive Entity Transaction Example</div>
...
<div className="text-center text-xs">Folder Entity Transaction Example</div>
...
<div className="text-center text-xs">Snapshot Transaction GQL tags example</div>
