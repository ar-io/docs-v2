...
<Tip>
  **Note**: This project is currently only accessible through the ar.io gateway and the arweave.net gateway.
</Tip>
...
4. **Frontend Development**: You'll clone the Zero-to-Arweave starter kit, which provides a solid foundation using Vite, React, and JavaScript along with the [AR.IO SDK](https://docs.ar.io/) and ArDrive SDKs.
...
* [**AR.IO**](https://docs.ar.io/) **SDK** for domain name management
...
3. An ARNS name (purchased from [arns.app](https://arns.app/))
...
6. Run the command to update your ARNS name with your application's manifest ID:
...
9. To verify all records associated with your ARNS name:
...
10. This will display all the records for your ARNS name, including the base record that should now point to your application.
